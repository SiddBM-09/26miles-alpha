  ...
  return (
    <div className="space-y-8 text-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
        <Link href="/dashboard" className="inline-flex items-center gap-2 rounded px-5 py-2.5 text-sm font-medium bg-accent hover:bg-accent/90 text-on-accent transition-colors">
            ...
            <li key={n} className="flex items-center flex-1 last:flex-none">
              <div className="flex flex-col items-center gap-1.5 flex-shrink-0">
                <div className={cn(
                  ...
                  done   ? "bg-profit border-profit text-on-accent" :
        ...
        {step < 3 ? (
          <button
            ...
            className={cn(
              ...
              ok ? "bg-accent hover:bg-accent/90 text-on-accent" : "bg-muted text-text-tertiary cursor-not-allowed"
            )}
          >
          ...
          <button
            onClick={onSubmit}
            disabled={submitting}
            className="inline-flex items-center gap-1.5 rounded px-5 py-2 text-sm font-semibold bg-accent hover:bg-accent/90 text-on-accent transition-colors disabled:opacity-60"
          >
            {submitting ? (
